...
public class ConstantsUtils {
    ...
    public static final String INTESIS_MESSAGE_SET_STATUS_OFF = "SET,1:ONOFF,OFF\r\n";
    public static final String ROOM_SENSOR_ID = "bleD94298C99EF2";
    public static final String WINDOW_SENSOR_ID = "bleD4DB5788634C";
}
